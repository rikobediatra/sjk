...
/**
 * The Travel_Joy_Customizer_Config object
 */
final class Travel_Joy_Customizer_Config {
	 ...
	 *
	 * @access private
	 * @param string $config_id @see Travel_Joy_Customizer_Config::get_instance().
	 * @param array  $args      @see Travel_Joy_Customizer_Config::get_instance().
	 */
	 ...
	 * }
	 *
	 * @return Travel_Joy_Customizer_Config
	 */
