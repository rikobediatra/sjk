 ...
 */
class Travel_Joy_Customizer_Settings {
	...
	/**
	 * Creates a new Travel_Joy_Customizer_Settings object.
	 * Class constructor.
	 *
	 * @access public
	 * @param array $args The field definition as sanitized in Travel_Joy_Customizer_Field.
	 */
	...
	final private function set_setting_types() {
		...
		$this->setting_types = apply_filters(
			...
			array(
				...
				'repeater'    => 'Travel_Joy_Customizer_Settings_Repeater_Setting',
				'user_meta'   => 'Travel_Joy_Customizer_Setting_User_Meta',
				'site_option' => 'Travel_Joy_Customizer_Setting_Site_Option',
			)
		);
