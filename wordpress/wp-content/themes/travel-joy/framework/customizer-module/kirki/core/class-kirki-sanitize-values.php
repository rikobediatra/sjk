 ...
 */
class Travel_Joy_Customizer_Sanitize_Values {
	 ...
	 *
	 * Deprecated. Use Travel_Joy_Customizer_Field_Checkbox::sanitize() instead.
	 *
	 * @static
	 * @access public
	 * @see Travel_Joy_Customizer_Field_Checkbox::sanitize()
	 * @param bool|string $value Whether the checkbox is checked.
	 * @return bool Whether the checkbox is checked.
	 */
	public static function checkbox( $value ) {
		$obj = new Travel_Joy_Customizer_Field_Checkbox();
