 ...
 */
class Travel_Joy_Customizer_L10n {
	...
	public function load_textdomain() {
		...
		load_plugin_textdomain( $this->textdomain, false, Travel_Joy_Customizer::$path . '/languages' );
	}
	...
	protected function get_paths() {
		return array(
			...
			Travel_Joy_Customizer::$path . '/languages/' . $this->textdomain . '-' . get_locale() . '.mo',
		);
	}
