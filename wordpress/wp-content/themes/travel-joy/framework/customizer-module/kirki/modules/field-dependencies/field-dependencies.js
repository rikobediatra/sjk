var kirkiDependencies = {
	...
	init: function() {
		...
		wp.customize.control.each( function( control ) {
			self.showTravelJoyCustomizerControl( control );
		} );
				...
				wp.customize( master, function( setting ) {
					var setupControl = function( control ) {
						...
						isDisplayed = function() {
							return self.showTravelJoyCustomizerControl( wp.customize.control( slave ) );
						};
	 ...
	 * @returns {bool}
	 */
	showTravelJoyCustomizerControl: function( control ) {
		var self     = this,
			show     = true,
			isOption = (
	 ...
	 * Check a condition.
	 *
	 * @param {Object} requirement - The requirement, inherited from showTravelJoyCustomizerControl.
