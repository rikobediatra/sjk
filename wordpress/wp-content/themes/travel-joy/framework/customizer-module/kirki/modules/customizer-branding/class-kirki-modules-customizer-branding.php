 ...
 */
class Travel_Joy_Customizer_Modules_Customizer_Branding {
	...
	public function customize_controls_print_scripts() {
		...
		if ( ! empty( $vars['logoImage'] ) || ! empty( $vars['description'] ) ) {
			wp_register_script( 'kirki-branding', Travel_Joy_Customizer::$url . '/modules/customizer-branding/branding.js', array(), TRAVEL_JOY_CUSTOMIZER_VERSION, false );
