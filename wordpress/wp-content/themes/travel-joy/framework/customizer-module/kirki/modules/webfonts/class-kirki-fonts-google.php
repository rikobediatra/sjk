 ...
 */
final class Travel_Joy_Customizer_Fonts_Google {

	/**
	 * The Travel_Joy_Customizer_Fonts_Google instance.
	...
	private function __construct() {
		...
		$this->google_fonts = Travel_Joy_Customizer_Fonts::get_google_fonts();
	}
	 ...
	 *
	 * @return object Travel_Joy_Customizer_Fonts_Google
	 */
	public static function get_instance() {
		if ( null === self::$instance ) {
			self::$instance = new Travel_Joy_Customizer_Fonts_Google();
		}
	...
	public function generate_google_font( $args ) {
		...
		if ( isset( $args['type'] ) && 'kirki-typography' === $args['type'] ) {
			...
			// Get the value.
			$value = Travel_Joy_Customizer_Values::get_sanitized_field_value( $args );
			...
			if ( ! isset( $value['font-family'] ) || ! Travel_Joy_Customizer_Fonts::is_google_font( $value['font-family'] ) ) {
				return;
			}
	...
	public function get_standardfonts_json() {
		echo wp_json_encode( Travel_Joy_Customizer_Fonts::get_standard_fonts() );
		wp_die();
	}
}
