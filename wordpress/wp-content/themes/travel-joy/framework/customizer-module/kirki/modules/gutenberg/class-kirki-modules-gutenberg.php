 ...
 * @since 3.0.35
 */
class Travel_Joy_Customizer_Modules_Gutenberg {
	...
	private function set_configs() {
		$this->configs = Travel_Joy_Customizer::$config;
		return $this->configs;
	}
	...
	private function set_modules_css() {
		$this->modules_css = Travel_Joy_Customizer_Modules_CSS::get_instance();
	}
	...
	private function set_google_fonts() {
		$this->google_fonts = Travel_Joy_Customizer_Fonts_Google::get_instance();
	}
	...
	private function set_modules_webfonts() {
		$this->modules_webfonts = Travel_Joy_Customizer_Modules_Webfonts::get_instance();
	}
}
