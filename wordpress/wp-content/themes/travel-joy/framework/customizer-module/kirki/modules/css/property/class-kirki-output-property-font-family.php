 ...
 * Output overrides.
 */
class Travel_Joy_Customizer_Output_Property_Font_Family extends Travel_Joy_Customizer_Output_Property {
	...
	protected function process_value() {
		$google_fonts_array = Travel_Joy_Customizer_Fonts::get_google_fonts();
