 ...
 */
class Travel_Joy_Customizer_Modules_PostMessage {
	...
	public function postmessage() {
		wp_enqueue_script( 'kirki_auto_postmessage', trailingslashit( Travel_Joy_Customizer::$url ) . 'modules/postmessage/postmessage.js', array( 'jquery', 'customize-preview' ), TRAVEL_JOY_CUSTOMIZER_VERSION, true );
