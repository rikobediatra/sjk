 ...
 */
class Travel_Joy_Customizer_Modules_Icons {
	...
	public function customize_controls_enqueue_scripts() {
		$sections = Travel_Joy_Customizer::$sections;
		$panels   = Travel_Joy_Customizer::$panels;
		...
		wp_enqueue_script( 'kirki_panel_and_section_icons', trailingslashit( Travel_Joy_Customizer::$url ) . 'modules/icons/icons.js', array( 'jquery', 'customize-base', 'customize-controls' ), TRAVEL_JOY_CUSTOMIZER_VERSION, true );
