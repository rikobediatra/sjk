 ...
 * Handles CSS output.
 */
final class Travel_Joy_Customizer_Modules_CSS_Generator {
	...
	private function __construct() {
		if ( is_null( self::$google_fonts ) ) {
			self::$google_fonts = Travel_Joy_Customizer_Fonts::get_google_fonts();
		}
	}
	...
	public static function css( $field ) {
		...
		self::$value = Travel_Joy_Customizer_Values::get_sanitized_field_value( $field );

		// Find the class that will handle the outpout for this field.
		$classname            = 'Travel_Joy_Customizer_Output';
		$default_classnames   = array(
			'kirki-background' => 'Travel_Joy_Customizer_Output_Field_Background',
			'kirki-dimensions' => 'Travel_Joy_Customizer_Output_Field_Dimensions',
			'kirki-image'      => 'Travel_Joy_Customizer_Output_Field_Image',
			'kirki-typography' => 'Travel_Joy_Customizer_Output_Field_Typography',
			'kirki-multicolor' => 'Travel_Joy_Customizer_Output_Field_Multicolor',
		);
