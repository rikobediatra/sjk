...
/**
 * The Travel_Joy_Customizer_Fonts object.
 */
final class Travel_Joy_Customizer_Fonts {
	 ...
	 *
	 * @return object Travel_Joy_Customizer_Fonts
	 */
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'travel-joy' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'travel-joy' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'travel-joy' ),
			'200'       => esc_html__( 'Light 200', 'travel-joy' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'travel-joy' ),
			'300'       => esc_html__( 'Book 300', 'travel-joy' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'travel-joy' ),
			'400'       => esc_html__( 'Normal 400', 'travel-joy' ),
			'regular'   => esc_html__( 'Normal 400', 'travel-joy' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'travel-joy' ),
			'500'       => esc_html__( 'Medium 500', 'travel-joy' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'travel-joy' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'travel-joy' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'travel-joy' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'travel-joy' ),
			'700'       => esc_html__( 'Bold 700', 'travel-joy' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'travel-joy' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'travel-joy' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'travel-joy' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'travel-joy' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'travel-joy' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'travel-joy' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'travel-joy' ),
		);
	}
