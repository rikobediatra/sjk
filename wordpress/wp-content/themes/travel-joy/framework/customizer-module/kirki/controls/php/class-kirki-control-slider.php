 ...
 */
class Travel_Joy_Customizer_Control_Slider extends Travel_Joy_Customizer_Control_Base {
	...
	protected function content_template() {
		...
		<label>
			...
			<div class="wrapper">
				...
				<span class="slider-reset dashicons dashicons-image-rotate"><span class="screen-reader-text"><?php esc_html_e( 'Reset', 'travel-joy' ); ?></span></span>
				<span class="value">
