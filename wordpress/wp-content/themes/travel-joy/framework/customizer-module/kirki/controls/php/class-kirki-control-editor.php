 ...
 * A TinyMCE control.
 */
class Travel_Joy_Customizer_Control_Editor extends Travel_Joy_Customizer_Control_Base {
	 ...
	 *
	 * The actual editor is added from the Travel_Joy_Customizer_Field_Editor class.
