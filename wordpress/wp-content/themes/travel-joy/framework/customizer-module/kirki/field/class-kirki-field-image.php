 ...
 * Field overrides.
 */
class Travel_Joy_Customizer_Field_Image extends Travel_Joy_Customizer_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'travel-joy' ),
				'change'       => esc_html__( 'Change image', 'travel-joy' ),
				'default'      => esc_html__( 'Default', 'travel-joy' ),
				'remove'       => esc_html__( 'Remove', 'travel-joy' ),
				'placeholder'  => esc_html__( 'No image selected', 'travel-joy' ),
				'frame_title'  => esc_html__( 'Select image', 'travel-joy' ),
				'frame_button' => esc_html__( 'Choose image', 'travel-joy' ),
			)
		);
	}
