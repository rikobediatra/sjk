 ...
 * Field overrides.
 */
class Travel_Joy_Customizer_Field_FontAwesome extends Travel_Joy_Customizer_Field_Select {
	...
	protected function set_choices() {
		ob_start();
		$json_path = wp_normalize_path( Travel_Joy_Customizer::$path . '/assets/vendor/fontawesome/fontawesome.json' );
