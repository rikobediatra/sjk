 ...
 * Field overrides.
 */
class Travel_Joy_Customizer_Field_Code extends Travel_Joy_Customizer_Field {
	...
	protected function set_sanitize_callback() {
		...
		$this->sanitize_callback = array( 'Travel_Joy_Customizer_Sanitize_Values', 'unfiltered' );
	}
}
