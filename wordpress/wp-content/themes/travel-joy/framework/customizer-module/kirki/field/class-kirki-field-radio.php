 ...
 * Field overrides.
 */
class Travel_Joy_Customizer_Field_Radio extends Travel_Joy_Customizer_Field {
	...
	protected function set_type() {
		...
		if ( in_array( $this->mode, array( 'buttonset', 'image' ), true ) ) {
			...
			_doing_it_wrong( __METHOD__, sprintf( esc_html__( 'Error in field %1$s. The "mode" argument has been deprecated since Kirki v0.8. Use the "radio-%2$s" type instead.', 'travel-joy' ), esc_html( $this->settings ), esc_html( $this->mode ) ), '3.0.10' );
